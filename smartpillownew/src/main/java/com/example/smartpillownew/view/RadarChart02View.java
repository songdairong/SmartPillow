...
public class RadarChart02View extends DemoView {
    ...
    private void chartRender() {
        try {
            ...
            chart.setTitle("一周睡眠详情");
            chart.getPlotTitle().getTitlePaint().setColor(Color.WHITE);
            chart.getPlotTitle().getTitlePaint().setTextSize(55f);
...
////		dataSeriesB.add(50d);
//
//        RadarData lineData2 = new RadarData("", dataSeriesB,
//                Color.rgb(75, 166, 51), XEnum.DataAreaStyle.STROKE);
//        lineData2.setLineStyle(XEnum.LineStyle.SOLID);
//        lineData2.getPlotLine().getDotPaint().setColor(Color.YELLOW);
...
////		dataSeriesC.add(85d);
//
//		RadarData lineData3 = new RadarData("",dataSeriesC,
...
//		chartData.add(lineData3);
        ...
        for (int i = 0; i < 7; i++) {
            ...
            LinkedList<Double> dataSeriesB = new LinkedList<Double>();
            for(int j=0 ; j<6 ; j++){
                dataSeriesB.add((double) ((random.nextInt(4)+2)*10));
            }
//		dataSeriesB.add(60d);
//		dataSeriesB.add(50d);
            ...
            lineData2.getPlotLine().setDotStyle(XEnum.DotStyle.RING);
            lineData2.getPlotLine().getLinePaint().setColor(Color.rgb(185, 163, 99));
    ...
    private void chartLabels() {
        ...
        labels.add("舒适度");
        labels.add("运动消耗/千卡");
        chart.getLabelPaint().setTextSize(30f);
