...
public class LinearChartRateViewNew extends View{
    ...
    public LinearChartRateViewNew(Context context) {
        this(context, null);
    }

    public LinearChartRateViewNew(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LinearChartRateViewNew(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawY(canvas);
        //画三条均值线
        drawNotifyLine("较低",40,Color.YELLOW,canvas);
        drawNotifyLine("正常",80,Color.GREEN,canvas);
        drawNotifyLine("较高",125,Color.RED,canvas);
        //画数据
        drawData(canvas);
    }
