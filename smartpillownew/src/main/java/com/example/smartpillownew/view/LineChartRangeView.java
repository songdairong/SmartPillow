 ...
 * @author XiongChuanLiang<br/>(xcl_168@aliyun.com)
 */
public class LineChartRangeView extends DemoView implements Runnable{

	private String TAG = "LineChartRangeView";
	...
	public LineChartRangeView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initView();
	}

	public LineChartRangeView(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
	 }

	 public LineChartRangeView(Context context, AttributeSet attrs, int defStyle) {
...
//			chart.addSubtitle("(XCL-Charts Demo)");
	...
	private void chartDataSet()
	{
		...
		dataSeries1.add(7d);
		dataSeries1.add(13d);
		LineData lineData1 = new LineData("每日翻身次数均值",dataSeries1,Color.rgb(234, 83, 71));
...
//		chart.setAnchorDataPoint(mAnchorSet);
	...
	{				
		mCustomLineDataset.add(new CustomLineData("较低",5d,Color.rgb(35, 172, 57),5));
		mCustomLineDataset.add(new CustomLineData("正常",10d,Color.rgb(69, 181, 248),5));
//		mCustomLineDataset.add(new CustomLineData("[个人均线]",calcAvg(),Color.rgb(251, 79, 128),6));
		mCustomLineDataset.add(new CustomLineData("较高",18d,Color.rgb(255, 0, 0),5));
	}
