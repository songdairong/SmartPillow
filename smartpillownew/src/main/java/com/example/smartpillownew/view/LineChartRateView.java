 ...
 * @author XiongChuanLiang<br/>(xcl_168@aliyun.com)
 */
public class LineChartRateView extends DemoView implements Runnable{

	private String TAG = "LineChartRateView";
	...
	public LineChartRateView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initView();
	}

	public LineChartRateView(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
	 }

	 public LineChartRateView(Context context, AttributeSet attrs, int defStyle) {
...
//			chart.addSubtitle("(XCL-Charts Demo)");
	...
	private void chartDataSet()
	{
		...
		dataSeries1.add(60d);
		dataSeries1.add(93d);
		dataSeries1.add(105d);
		dataSeries1.add(86d);
		dataSeries1.add(100d);
		dataSeries1.add(130d);
		LineData lineData1 = new LineData("每日心率均值",dataSeries1,Color.rgb(234, 83, 71));
...
//		chart.setAnchorDataPoint(mAnchorSet);
	...
	{				
		mCustomLineDataset.add(new CustomLineData("较低",60d,Color.rgb(35, 172, 57),5));
		mCustomLineDataset.add(new CustomLineData("正常",120d,Color.rgb(69, 181, 248),5));
//		mCustomLineDataset.add(new CustomLineData("[个人均线]",calcAvg(),Color.rgb(251, 79, 128),6));
		mCustomLineDataset.add(new CustomLineData("较高",160d,Color.rgb(255, 0, 0),5));
	}
