...
public class SleepDetailInfoActivity extends Activity {

    private static final String TAG = "SleepDetailInfoActivity";
    ...
    PathView2 breathView;
    private String data;
    private int[] breathdataList = new int[]{0, 0, 0, 0, 0, 0};
    private int[] breathrangeList = new int[]{0, 0, 0, 0, 0, 0};
...
//        tvHaveMenBreath.setText(bean.getEmpty() == );
            ...
            if (result < 16) {
                tvPointRangeBreath.setText("0~16");
                tvCurrentPointBreath.setTextColor(Color.RED);
            } else if (result > 25) {
                tvPointRangeBreath.setText(">25");
                tvCurrentPointBreath.setTextColor(Color.RED);
            } else {
                tvPointRangeBreath.setText("16~25");
            ...
            addData(result, breathdataList);
            addData(range, breathrangeList);
            breathView.getData(breathdataList, breathrangeList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sleep_detail_info);
    ...
    private void initTitle() {
        titleTitleName.setText("睡眠：呼吸详细信息");
    }
