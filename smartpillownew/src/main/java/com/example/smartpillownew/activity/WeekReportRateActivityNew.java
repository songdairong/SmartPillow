...
import com.example.smartpillownew.view.LinearChartRateViewNew;
...
public class WeekReportRateActivityNew extends Activity {
    ...
    LinearChartRateViewNew newLinearChartView;
    ...
    private void processData(String json) {
        ...
        if (bean.getStatus() ==1){
            ...
            //显示数据
            String[] data1 = {"120","90","85","70","95","103","70"};
    ...
    /**将服务器传过来的数据，把null改为0，把double类型改为int
     * @param data
     * @return
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week_report_rate_new);
        ButterKnife.bind(this);

        titleTitleName.setText("心率");
        ...
        new Thread(){
            ...
            public void run() {
                super.run();
                try {
                    String data = getDataFromNet(Constance.BASE_URL_WEEK_DATA+"heart");
