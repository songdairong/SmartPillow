...
public class LinearChartRangeViewNew extends View{
    ...
    public LinearChartRangeViewNew(Context context) {
        this(context, null);
    }

    public LinearChartRangeViewNew(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LinearChartRangeViewNew(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawNotifyLine("正常",15,Color.GREEN,canvas);
        drawNotifyLine("较高",30,Color.RED,canvas);
        //画数据
        drawData(canvas);
    }
