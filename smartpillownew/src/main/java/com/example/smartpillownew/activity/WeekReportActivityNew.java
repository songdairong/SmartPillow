...
import com.example.smartpillownew.view.LinearChartBreathViewNew;
...
public class WeekReportActivityNew extends Activity {

    private static final String TAG = "WeekReportActivityNew";
    ...
    LinearChartBreathViewNew newLinearChartView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week_report_new);
        ButterKnife.bind(this);

        titleTitleName.setText("呼吸");
        ...
        new Thread(){
            ...
            public void run() {
                super.run();
                try {
                    String data = getDataFromNet(Constance.BASE_URL_WEEK_DATA+"breath");
