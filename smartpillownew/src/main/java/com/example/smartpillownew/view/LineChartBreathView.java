 ...
 * @author XiongChuanLiang<br/>(xcl_168@aliyun.com)
 */
public class LineChartBreathView extends DemoView implements Runnable{

	private static final int RECIEVE_DATA = 0;
	private String TAG = "LineChartBreathView";
	...
	private ChartPointListener onClickListener;


	public LineChartBreathView(Context context) {
		super(context);
	...
	public LineChartBreathView(Context context, AttributeSet attrs){
        super(context, attrs);

        initView();
	 }
	 
	 public LineChartBreathView(Context context, AttributeSet attrs, int defStyle) {
...
//		chart.setAnchorDataPoint(mAnchorSet);
	...
	{				
		mCustomLineDataset.add(new CustomLineData("较低",15d,Color.rgb(35, 172, 57),5));
		mCustomLineDataset.add(new CustomLineData("正常",25d,Color.rgb(69, 181, 248),5));
		mCustomLineDataset.add(new CustomLineData("[个人均线]",calcAvg(),Color.rgb(251, 79, 128),6));
		mCustomLineDataset.add(new CustomLineData("较高",40d,Color.rgb(255, 0, 0),5));
	}
	...
	private void triggerClick(float x,float y)
	{
		...
		LineData pData = chartData.get(record.getDataID());
	...
	public void setOnPointClickListener(ChartPointListener pointListener)
	{
		this.onClickListener = pointListener;
	}
