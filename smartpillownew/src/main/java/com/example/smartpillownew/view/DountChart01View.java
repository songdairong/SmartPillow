...
public class DountChart01View extends DemoView {
	...
	public DountChart chart = new DountChart();
	
	LinkedList<PieData> lPieData = new LinkedList<PieData>();

	public void getData(LinkedList<PieData> data){
		lPieData.addAll(data);
	}
...
//			chart.setBackgroundColor(R.color.baolan);
			 
			//内环背景色
			chart.getInnerPaint().setColor(getResources().getColor(R.color.baolan));
...
//		lPieData.add(new PieData("清醒","10%",10,Color.rgb(77, 83, 97)));
//		lPieData.add(new PieData("深度睡眠","30%",30,Color.rgb(148, 159, 181)));
//		lPieData.add(new PieData("浅度睡眠","60%",60,Color.rgb(253, 180, 90)));
